...
function CategoryBlock({ category }: { category: Category }) {
  return (
    <section id={category.id} className="scroll-mt-28 py-10">
      <div className="mb-6 flex items-start gap-4">
        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-[#f2e8d6] text-2xl">{category.emoji}</div>
        <div>
          <h2 className="font-serif text-3xl font-semibold text-[#17324a] md:text-4xl">{category.title}</h2>
          <p className="mt-2 max-w-2xl text-base leading-7 text-[#68727a]">{category.subtitle}</p>
        </div>
      </div>
      ...
      <main className="bg-[#fbfaf7] text-[#17324a]">
        ...
        <section id="marghera" className="scroll-mt-20">
          ...
          <div className="mx-auto max-w-7xl px-5 py-6 md:px-8">
            <nav className="flex flex-wrap gap-2 py-4" aria-label="Categorie Marghera">
        ...
        <section id="venezia" className="scroll-mt-20">
          ...
          <div className="mx-auto max-w-7xl px-5 py-6 md:px-8">
            <nav className="flex flex-wrap gap-2 py-4" aria-label="Categorie Venezia">
