...
const data=acquaAltaAudit.fr;
export const metadata=editorialMetadata({lang:'fr',logicalPath:'/journal/acqua-alta-a-venezia',title:data.title,description:data.description,image:data.image,alt:data.imageAlt});
