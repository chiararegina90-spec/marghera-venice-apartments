...
const path='/fr/journal/mostra-del-cinema';

export const metadata:Metadata={
  title:data.metaTitle,
  description:data.metaDescription,
  alternates:languageAlternates(path),
  openGraph:{type:'article',title:data.metaTitle,description:data.metaDescription,url:path,locale:'fr_FR',images:['/images/journal-mostra-cinema.webp']},
