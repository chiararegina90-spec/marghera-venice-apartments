  ...
  return <><Header/><main>
    <section className="bg-navy px-5 pb-20 pt-36 text-white lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="text-xs font-black uppercase tracking-[.22em] text-gold">Esperienze selezionate</p>
        <h1 className="mt-4 max-w-5xl font-serif text-6xl leading-none md:text-8xl">Vivi Venezia anche attraverso chi la conosce davvero.</h1>
        <p className="mt-6 max-w-3xl text-xl text-white/75">Attività autentiche e operatori locali da conoscere, con informazioni chiare e collegamenti diretti alle fonti ufficiali.</p>
      </div>
    </section>
