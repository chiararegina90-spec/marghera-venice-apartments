...
const content=parkingStayContent.zh;
export const metadata:Metadata={
  title:{absolute:content.seoTitle},
  description:content.metaDescription,
  alternates:languageAlternates('/zh/apartments-near-venice-free-parking'),
...
export default function Page(){return <ParkingStayPage lang="zh"/>;}
