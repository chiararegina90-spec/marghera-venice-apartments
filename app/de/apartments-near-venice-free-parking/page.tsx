...
const content=parkingStayContent.de;
export const metadata:Metadata={
  title:{absolute:content.seoTitle},
  description:content.metaDescription,
  alternates:languageAlternates('/de/apartments-near-venice-free-parking'),
...
export default function Page(){return <ParkingStayPage lang="de"/>;}
