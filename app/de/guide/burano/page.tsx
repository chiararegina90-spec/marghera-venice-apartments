...
export const metadata:Metadata={
 ...
 openGraph:{title:`${data.title} Reiseführer | Marghera Venice Apartments`,description:data.description,url:'/de/guide/burano',locale:'de_DE',type:'article',images:[data.image]},
