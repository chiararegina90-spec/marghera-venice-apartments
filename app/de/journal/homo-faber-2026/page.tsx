...
const data=homoFaber2026['de'];
const image='/images/journal-homo-faber-2026-cover.webp';

export const metadata:Metadata={
  title:data.seoTitle,
  description:data.metaDescription,
  alternates:languageAlternates('/de/journal/homo-faber-2026'),
  openGraph:{type:'article',title:data.seoTitle,description:data.metaDescription,url:'/de/journal/homo-faber-2026',locale:'de_DE',images:[{url:image,alt:data.imageAlt}]},
