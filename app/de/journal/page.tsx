...
export const metadata:Metadata={title:'Journal',description:'Reisetipps, Veranstaltungen, venezianische Traditionen und praktische Hinweise für einen entspannten Aufenthalt in Venedig und der Lagune.',alternates:{canonical:'/de/journal',languages:{'it-IT':'/journal','en-GB':'/en/journal','de-DE':'/de/journal','fr-FR':'/fr/journal','es-ES':'/es/journal','zh-CN':'/zh/journal','x-default':'/journal'}},openGraph:{type:'website',images:['/images/home-rialto-vincenzo-landino.webp']},twitter:{card:'summary_large_image',images:['/images/home-rialto-vincenzo-landino.webp']}}; const items:[string,string][]=[
