...
export default function Article(){
  ...
  return <><Header/><main><article className="editorial-page">
    ...
    <section className="relative min-h-[64svh] overflow-hidden pt-20 sm:min-h-[72vh]"><Image src="/images/journal-carnevale.webp" alt="Maschere durante il Carnevale di Venezia" fill priority sizes="100vw" className="object-cover"/><div className="absolute inset-0 editorial-cover-shade"/><div className="relative mx-auto flex min-h-[calc(64svh-5rem)] max-w-7xl items-end px-5 pb-16 pt-20 sm:min-h-[calc(72vh-5rem)] lg:px-8"><div className="max-w-5xl text-white"><nav aria-label="Breadcrumb" className="mb-5 flex flex-wrap gap-2 text-sm text-white/70"><Link href="/">Home</Link><span>›</span><Link href="/journal">Journal</Link><span>›</span><span className="text-gold">Carnevale di Venezia 2027</span></nav><p className="text-xs font-black uppercase tracking-[.22em] text-gold">Eventi • 23 gennaio – 9 febbraio 2027</p><h1 className="mt-4 font-serif text-[clamp(2.8rem,7vw,5.8rem)] leading-none">Carnevale di Venezia 2027</h1><p className="mt-6 max-w-3xl text-xl text-white/80">Date ufficiali, ciò che è già confermato e come organizzare la visita senza confondere il programma 2026 con quello del 2027.</p></div></div></section>
