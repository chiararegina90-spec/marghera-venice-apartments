...
const content=parkingStayContent.en;
export const metadata:Metadata={
  title:{absolute:content.seoTitle},
  description:content.metaDescription,
  alternates:languageAlternates('/en/apartments-near-venice-free-parking'),
...
export default function Page(){return <ParkingStayPage lang="en"/>;}
