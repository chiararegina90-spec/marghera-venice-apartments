...
const data=homoFaber2026['en'];
const image='/images/journal-homo-faber-2026-cover.webp';

export const metadata:Metadata={
  title:data.seoTitle,
  description:data.metaDescription,
  alternates:languageAlternates('/en/journal/homo-faber-2026'),
  openGraph:{type:'article',title:data.seoTitle,description:data.metaDescription,url:'/en/journal/homo-faber-2026',locale:'en_GB',images:[{url:image,alt:data.imageAlt}]},
