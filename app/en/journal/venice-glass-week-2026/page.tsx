...
export default function Page(){return <><JournalSchemaBundle lang="en" logicalPath="/journal/venice-glass-week-2026" title={data.h1} description={data.metaDescription} image={image} dateModified="2026-09-26" event={{startDate:'2026-09-12',endDate:'2026-09-20',locationName:'Venice, Murano and Mestre'}}/><GlassWeek2026Article data={data}/></>;}
