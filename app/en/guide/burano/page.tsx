...
export const metadata:Metadata={
 title:'Burano Guide: Things to See & How to Get There',
 ...
 openGraph:{title:`${data.title} Travel Guide`,description:data.description,url:'/en/guide/burano',locale:'en_GB',type:'article',images:[data.image]},
