...
export const metadata:Metadata={
 ...
 openGraph:{title:`${data.title} Travel Guide | Marghera Venice Apartments`,description:data.description,url:'/en/guide/chioggia',locale:'en_GB',type:'article',images:[data.image]},
