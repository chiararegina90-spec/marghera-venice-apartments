...
<p className="mt-6 max-w-3xl text-xl text-white/75">Practical ideas, day trips and local context to understand the destination, not just collect sights.</p>
</div></section>
<GuideDirectoryIndex lang="en" items={guides.map(g=>({slug:g[5],title:g[0],subtitle:g[1],text:g[2],image:g[3],alt:g[4]}))}/>
</main><Footer lang="en"/></>}
