...
export const metadata:Metadata={
 title:'Prosecco Hills from Venice | Day Trip Guide',
 ...
 openGraph:{title:`${data.title} Travel Guide`,description:data.description,url:'/en/guide/colline-del-prosecco',locale:'en_GB',type:'article',images:[data.image]},
