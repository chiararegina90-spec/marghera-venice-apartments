...
export const metadata:Metadata={
 title:'Venice Lido Guide: Beaches, Bikes & Things to Do',
 ...
 openGraph:{title:`${data.title} Travel Guide`,description:data.description,url:'/en/guide/lido-di-venezia',locale:'en_GB',type:'article',images:[data.image]},
