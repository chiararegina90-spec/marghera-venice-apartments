...
const data=glassWeek2026['es'];
const image='/images/journal-venice-glass-week-2026-cover.webp';

export const metadata:Metadata={
  title:data.seoTitle,
  description:data.metaDescription,
  alternates:languageAlternates('/es/journal/venice-glass-week-2026'),
  openGraph:{type:'article',title:data.seoTitle,description:data.metaDescription,url:'/es/journal/venice-glass-week-2026',locale:'es_ES',images:[{url:image,alt:data.imageAlt}]},
