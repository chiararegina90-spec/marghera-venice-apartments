...
const data=acquaAltaAudit.es;
export const metadata=editorialMetadata({lang:'es',logicalPath:'/journal/acqua-alta-a-venezia',title:data.title,description:data.description,image:data.image,alt:data.imageAlt});
