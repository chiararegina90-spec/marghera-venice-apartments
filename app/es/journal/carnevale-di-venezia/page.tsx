...
const data={...journalEs['carnevale-di-venezia'],...journalAuditLocalized.es['carnevale-di-venezia']} as unknown as JournalArticleData;
export const metadata=editorialMetadata({lang:'es',logicalPath:'/journal/carnevale-di-venezia',title:data.title,description:data.description,image:data.image,alt:data.imageAlt});
