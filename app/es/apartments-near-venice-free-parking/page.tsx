...
const content=parkingStayContent.es;
export const metadata:Metadata={
  title:{absolute:content.seoTitle},
  description:content.metaDescription,
  alternates:languageAlternates('/es/apartments-near-venice-free-parking'),
...
export default function Page(){return <ParkingStayPage lang="es"/>;}
