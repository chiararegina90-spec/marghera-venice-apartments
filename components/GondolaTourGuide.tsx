    ...
    <main><article className="editorial-page">
      ...
      <section className="bg-cream py-16 sm:py-20"><div className="mx-auto max-w-5xl px-5 lg:px-8">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-2">
          <div className="rounded-[2rem] bg-white p-7 shadow-soft ring-1 ring-black/5"><p className="text-xs font-black uppercase tracking-[.16em] text-gold">{c.dayLabel}</p><p className="mt-2 font-serif text-3xl text-navy">{c.dayTime}</p><p className="mt-5 font-serif text-5xl text-navy sm:text-6xl">{c.dayPrice}</p><p className="mt-2 text-slate-600">{c.dayDuration}</p></div>
          <div className="rounded-[2rem] bg-navy p-7 text-white shadow-soft"><p className="text-xs font-black uppercase tracking-[.16em] text-gold">{c.nightLabel}</p><p className="mt-2 font-serif text-3xl">{c.nightTime}</p><p className="mt-5 font-serif text-5xl sm:text-6xl">{c.nightPrice}</p><p className="mt-2 text-white/70">{c.nightDuration}</p></div>
        </div>
