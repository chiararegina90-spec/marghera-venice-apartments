...
export default function EditorialHero({image,imageAlt,crumbs,eyebrow,title,subtitle,children,imagePosition='object-center',strongShade=false,credit}:Props){
  return <section className="relative min-h-[64svh] overflow-hidden pt-20 text-white sm:min-h-[72vh]">
    ...
    <div className="relative mx-auto flex min-h-[calc(64svh-5rem)] max-w-7xl sm:min-h-[calc(72vh-5rem)] items-end px-5 pb-12 pt-20 sm:pb-14 lg:px-8">
      <div className="hero-copy max-w-4xl">
        <nav aria-label="Breadcrumb" className="mb-4 flex flex-wrap items-center gap-2 text-sm text-white/75">
