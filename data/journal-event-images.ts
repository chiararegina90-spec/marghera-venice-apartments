...
export const journalEventImages:Record<string,JournalEventImagePair>={
  ...
  'festa-madonna-salute-venezia':{card:'/images/journal-events/festa-madonna-salute-venezia-card.svg',cover:'/images/journal-events/festa-madonna-salute-venezia-cover.svg'},
};
