...
export const amerigoVespucci2026Update:Record<VespucciAuditLang,VespucciUpdate>={
  it:{
    ...
    sections:[
      ...
      ['Visite a bordo: cosa sappiamo davvero','Al 15 settembre 2026 non risulta ancora pubblicata una pagina operativa specifica per Venezia con i giorni esatti delle visite pubbliche, le fasce orarie, la disponibilità degli slot o le modalità definitive di accesso e prenotazione. Non estendiamo quindi a Venezia le regole applicate in altre tappe.'],
    ...
    faq:[
      ['Serve prenotare la visita a bordo?','Al 15 settembre 2026 non sono ancora pubblicate le modalità operative della tappa veneziana. Non diamo quindi per certa né la prenotazione né l’entrata diretta finché non saranno comunicate ufficialmente.'],
  ...
  en:{
    ...
    sections:[
      ...
      ['Onboard visits: what is actually confirmed','As of 15 September 2026, no Venice-specific operational page has been published with exact public visiting days, time slots, slot availability or final access and booking procedures. Rules used at other Italian stops should therefore not be assumed for Venice.'],
    ...
    faq:[
      ['Do I need to book an onboard visit?','As of 15 September 2026, Venice public-access arrangements have not yet been published, so neither booking nor walk-up entry should be assumed until officially confirmed.'],
  ...
  de:{
    ...
    sections:[
      ...
      ['Bordbesichtigungen: aktueller Stand','Am 15. September 2026 gibt es noch keine operative Seite für Venedig mit genauen Besuchstagen, Zeitfenstern, Verfügbarkeit oder endgültigen Zugangs- und Reservierungsregeln. Die Regeln anderer Stationen werden daher nicht automatisch auf Venedig übertragen.'],
    ...
    faq:[
      ['Muss eine Bordbesichtigung reserviert werden?','Am 15. September 2026 sind die Zugangsregeln für Venedig noch nicht veröffentlicht. Weder Reservierung noch direkter Zugang sollten daher vorausgesetzt werden.'],
  ...
  fr:{
    ...
    sections:[
      ...
      ['Visites à bord : ce qui est confirmé','Au 15 septembre 2026, aucune page opérationnelle propre à Venise ne précise encore les jours exacts, créneaux horaires, disponibilités ou modalités définitives d’accès et de réservation. Les règles des autres escales ne sont donc pas appliquées automatiquement à Venise.'],
    ...
    faq:[
      ['Faut-il réserver une visite à bord ?','Au 15 septembre 2026, les modalités d’accès du public à Venise ne sont pas encore publiées. Il ne faut donc supposer ni réservation ni accès direct avant confirmation officielle.'],
  ...
  es:{
    ...
    sections:[
      ...
      ['Visitas a bordo: lo que sabemos','A 15 de septiembre de 2026 todavía no se ha publicado una página operativa específica de Venecia con días exactos, franjas horarias, disponibilidad de plazas o normas definitivas de acceso y reserva. Por tanto, no aplicamos automáticamente a Venecia las reglas de otras escalas.'],
    ...
    faq:[
      ['¿Hay que reservar la visita a bordo?','A 15 de septiembre de 2026 todavía no se han publicado las modalidades de acceso al público en Venecia, así que no conviene dar por hecha ni la reserva ni la entrada directa hasta que exista confirmación oficial.'],
  ...
  zh:{
    ...
    sections:[
      ...
      ['登船参观：目前确认到哪一步','截至2026年9月15日，威尼斯站尚未发布列明公众参观具体日期、时间段、名额以及最终入场或预约方式的操作页面。因此不会把其他城市停靠站的规则直接套用到威尼斯。'],
    ...
    faq:[
      ['登船参观需要预约吗？','截至2026年9月15日，威尼斯站面向公众的入场方式尚未公布，因此目前不能确定是否需要预约，也不能假设可以直接现场入场。'],
