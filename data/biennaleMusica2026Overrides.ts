import type {EventLang} from './journal-events-2026';

export const biennaleMusica2026Overrides:Record<EventLang,Record<string,unknown>> = {
  "it": {
    ...
    "sections": [
      [
        "Biennale Musica 2026 in numeri",
        "Dal 10 al 24 ottobre il Festival Internazionale di Musica Contemporanea presenta 130 artisti in oltre 40 appuntamenti. Le 23 nuove opere — 18 in prima assoluta — attraversano concerti, installazioni, performance, progetti site-specific e Biennale College, con l’Arsenale come uno dei principali poli del programma."
      ],
      [
        "Ennio Morricone: Musica per una fine",
        "Tra gli appuntamenti più significativi c’è la prima esecuzione assoluta di Musica per una fine, lavoro inedito di Ennio Morricone pubblicato postumo e costruito attorno a una poesia di Pier Paolo Pasolini. Il progetto mette in relazione la scrittura di Morricone con un programma che attraversa anche Bach e una nuova commissione a Sarah Davachi."
      ],
      [
        "Keiji Haino, Leone d’Oro alla carriera",
        "Il pioniere della scena noise giapponese Keiji Haino riceve il Leone d’Oro alla carriera 2026. Alla Biennale presenta un concerto site-specific per voce e strumenti a corda e un documentario sulla sua carriera diretto da Kazuhiro Shirao, mai mostrato prima fuori dal Giappone."
      ],
      [
        "Sarah Davachi, Leone d’Argento",
    ...
    "official": [
      "Sito ufficiale Biennale Musica 2026",
      "https://www.labiennale.org/it/musica/2026"
    ],
    "relatedSlugs": [
    ...
    "eventLocations": [
      {
        "name": "Teatro Piccolo Arsenale",
        "addressLocality": "Venezia",
        "addressCountry": "IT"
      },
      {
        "name": "Teatro alle Tese",
        "addressLocality": "Venezia",
        "addressCountry": "IT"
      },
      {
        "name": "Tese dei Soppalchi",
        "addressLocality": "Venezia",
        "addressCountry": "IT"
      },
      {
        "name": "Sale d’Armi, Arsenale",
        "addressLocality": "Venezia",
        "addressCountry": "IT"
      },
      {
  ...
  "en": {
    ...
    "sections": [
      [
        "Biennale Musica 2026 in numbers",
        "From 10 to 24 October, the International Festival of Contemporary Music presents 130 artists across more than 40 events. Its 23 new works — 18 world premieres — move between concerts, installations, performances, site-specific projects and Biennale College, with the Arsenale as one of the programme’s main hubs."
      ],
      [
        "Ennio Morricone: Musica per una fine",
        "One of the programme’s key moments is the world premiere of Musica per una fine, a previously unreleased work by Ennio Morricone, published posthumously and built around a poem by Pier Paolo Pasolini. It appears in a programme that also connects Morricone with Bach and a new commission for Sarah Davachi."
      ],
      [
        "Keiji Haino, Golden Lion for Lifetime Achievement",
        "Japanese noise pioneer Keiji Haino receives the 2026 Golden Lion for Lifetime Achievement. At Biennale Musica he presents a site-specific concert for voice and string instruments as well as a career documentary directed by Kazuhiro Shirao, shown outside Japan for the first time."
      ],
      [
        "Sarah Davachi, Silver Lion",
    ...
    "official": [
      "Official Biennale Musica 2026 website",
  ...
  "de": {
    ...
    "sections": [
      [
        "Biennale Musica 2026 in Zahlen",
        "Vom 10. bis 24. Oktober umfasst das Festival 130 Künstler und mehr als 40 Veranstaltungen. 23 neue Werke, davon 18 Uraufführungen, verteilen sich auf Konzerte, Installationen, Performances, ortsspezifische Projekte und Biennale College. Das Arsenale ist dabei einer der wichtigsten Festivalorte."
      ],
      [
        "Ennio Morricone: Musica per una fine",
        "Ein zentraler Programmpunkt ist die Uraufführung von Musica per una fine, einem bisher unveröffentlichten Werk Ennio Morricones, das posthum veröffentlicht wurde und auf einem Gedicht von Pier Paolo Pasolini basiert. Im selben Programm treffen Morricone, Bach und eine neue Auftragsarbeit für Sarah Davachi aufeinander."
      ],
      [
        "Keiji Haino, Goldener Löwe für das Lebenswerk",
        "Der japanische Noise-Pionier Keiji Haino erhält 2026 den Goldenen Löwen für sein Lebenswerk. Bei der Biennale Musica präsentiert er ein ortsspezifisches Konzert für Stimme und Saiteninstrumente sowie einen von Kazuhiro Shirao gedrehten Dokumentarfilm über seine Karriere, der erstmals außerhalb Japans gezeigt wird."
      ],
      [
        "Sarah Davachi, Silberner Löwe",
    ...
    "official": [
      "Offizielle Website Biennale Musica 2026",
      "https://www.labiennale.org/en/music/2026"
    ],
    "relatedSlugs": [
      "venice-design-week-2026"
  ...
  "fr": {
    ...
    "sections": [
      [
        "Biennale Musica 2026 en chiffres",
        "Du 10 au 24 octobre, le Festival international de musique contemporaine réunit 130 artistes pour plus de 40 rendez-vous. Les 23 nouvelles œuvres — dont 18 créations mondiales — prennent la forme de concerts, installations, performances, projets in situ et propositions de Biennale College, avec l’Arsenale comme l’un des pôles majeurs."
      ],
      [
        "Ennio Morricone : Musica per una fine",
        "Parmi les temps forts figure la création mondiale de Musica per una fine, œuvre inédite d’Ennio Morricone publiée à titre posthume et construite autour d’un poème de Pier Paolo Pasolini. Le programme met aussi cette pièce en regard de Bach et d’une nouvelle commande à Sarah Davachi."
      ],
      [
        "Keiji Haino, Lion d’or pour l’ensemble de sa carrière",
        "Pionnier japonais de la scène noise, Keiji Haino reçoit le Lion d’or 2026 pour l’ensemble de sa carrière. À la Biennale Musica, il présente un concert in situ pour voix et instruments à cordes ainsi qu’un documentaire de Kazuhiro Shirao consacré à son parcours, montré pour la première fois hors du Japon."
      ],
      [
        "Sarah Davachi, Lion d’argent",
    ...
    "official": [
      "Site officiel Biennale Musica 2026",
      "https://www.labiennale.org/en/music/2026"
    ],
    "relatedSlugs": [
      "venice-design-week-2026"
  ...
  "es": {
    ...
    "sections": [
      [
        "Biennale Musica 2026 en cifras",
        "Del 10 al 24 de octubre, el Festival Internacional de Música Contemporánea reúne a 130 artistas en más de 40 citas. Las 23 nuevas obras, 18 de ellas estrenos mundiales, se reparten entre conciertos, instalaciones, performances, proyectos específicos para cada espacio y Biennale College, con el Arsenale como uno de los principales núcleos."
      ],
      [
        "Ennio Morricone: Musica per una fine",
        "Uno de los momentos destacados es el estreno mundial de Musica per una fine, obra inédita de Ennio Morricone publicada póstumamente y construida en torno a un poema de Pier Paolo Pasolini. El programa la pone en diálogo con Bach y con un nuevo encargo para Sarah Davachi."
      ],
      [
        "Keiji Haino, León de Oro a toda una carrera",
        "El pionero japonés del noise Keiji Haino recibe el León de Oro a toda una carrera 2026. En la Biennale Musica presenta un concierto site-specific para voz e instrumentos de cuerda y un documental sobre su trayectoria dirigido por Kazuhiro Shirao, que se muestra por primera vez fuera de Japón."
      ],
      [
        "Sarah Davachi, León de Plata",
    ...
    "official": [
      "Web oficial Biennale Musica 2026",
      "https://www.labiennale.org/en/music/2026"
    ],
    "relatedSlugs": [
      "venice-design-week-2026"
  ...
  "zh": {
    ...
    "sections": [
      [
        "2026威尼斯音乐双年展：几个关键数字",
        "10月10日至24日，国际当代音乐节将呈现130位艺术家的40多场活动。23部新作中有18部世界首演，形式包括音乐会、声音装置、表演、场地特定项目和 Biennale College；Arsenale 是本届音乐节的重要区域之一。"
      ],
      [
        "Ennio Morricone：Musica per una fine",
        "节目中的重要首演之一是 Ennio Morricone 的 Musica per una fine。这部未发表作品在作曲家去世后出版，以 Pier Paolo Pasolini 的诗作为核心，并与 Bach 的作品以及 Sarah Davachi 的新委约作品安排在同一节目脉络中。"
      ],
      [
        "Keiji Haino：终身成就金狮奖",
        "日本 noise 与即兴音乐的重要人物 Keiji Haino 获得2026终身成就金狮奖。他将在 Biennale Musica 带来一场为声音与弦乐器设计的场地特定音乐会，并呈现由 Kazuhiro Shirao 执导的职业生涯纪录片；该片将首次在日本以外放映。"
      ],
      [
        "Sarah Davachi：银狮奖",
