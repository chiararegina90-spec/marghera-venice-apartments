...
export default function Page(){return <LocalizedGuideIndex lang="de" title='Reiseführer für Venedig & Venetien' subtitle='Praktische Reiseideen für Venedig, die Lagune und Ausflüge in Venetien.' items={items} openLabel='Reiseführer öffnen'/>}
